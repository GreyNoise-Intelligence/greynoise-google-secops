...
| Field | Mapping Value | Description |
|-------|---------------|-------------|
| **TicketID** | `alert.id` | Unique identifier for the alert |
| **SourceSystemName** | `GreyNoise` | Identifies the source system |
| **Name** | `alert.name` | Name of the alert |
| **DeviceVendor** | `GreyNoise` | Vendor information |
| **RuleGenerator** | `event_type` | Type of alert event |
| **StartTime** | `timestamp` | Time the alert was generated |
| **Reason** | `alert.creator` | Creator of the alert |
| **DeviceProduct** | `GreyNoise-Alert` | Product information |
| **EndTime** | `timestamp` | Time the alert ended |
| **Priority** | `data.classification` | Classification of the alert |
| **EventsList** | `first(1)` | List of events |
| **EventProduct** | `GreyNoise` | Product information |
| **EventName** | `alert.name` | Name of the event |
...
| Field | Mapping Value | Description |
|-------|---------------|-------------|
| **TicketID** | `cve` | Unique identifier for the CVE event |
| **SourceSystemName** | `GreyNoise` | Identifies the source system |
| **Name** | `event_type` | Type of CVE event |
| **DeviceVendor** | `GreyNoise` | Vendor information |
| **RuleGenerator** | `GreyNoise Alert` | Static value for consistency |
| **StartTime** | `timestamp` | Time the event was generated |
| **DeviceProduct** | `GreyNoise-Feed` | Product information |
| **EndTime** | `timestamp` | Time the event ended |
| **EventsList** | `first(1)` | List of events |
| **EventProduct** | `GreyNoise` | Product information |
| **EventName** | `event_type` | Name of the event |
...
| Field | Mapping Value | Description |
|-------|---------------|-------------|
| **TicketID** | `ip` | Unique identifier for the IP event |
| **SourceSystemName** | `GreyNoise` | Identifies the source system |
| **Name** | `event_type` | Type of IP event |
| **DeviceVendor** | `GreyNoise` | Vendor information |
| **RuleGenerator** | `event_type` | Type of IP event |
| **StartTime** | `timestamp` | Time the event was generated |
| **DeviceProduct** | `GreyNoise-Feed` | Product information |
| **EndTime** | `timestamp` | Time the event ended |
| **Priority** | `new_state.classification` | New classification state |
| **EventsList** | `first(1)` | List of events |
| **EventProduct** | `GreyNoise` | Product information |
| **EventName** | `event_type` | Name of the event |
